...
<body>
    <div class="wrapper">
        <div class="flex-introduction">
            <div class="flex-introduction-item slight-smooth-zoom">
            ...
            <div class="flex-introduction-image" style="object-fit: cover; max-width: 300px; text-align: left">
